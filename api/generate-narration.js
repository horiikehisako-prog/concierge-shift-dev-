...
const API_BUILD_ID = "sprint27-openai-diagnostics-20260711.19";
...
const buildFastSystemPrompt = extraInstruction => [
  ...
  "Closing should not become a lesson such as 'live this way' or 'move forward'. Prefer words such as support, warmth, face remembered, memory, remaining in the heart, and inherited feeling, but only when connected to a concrete memory.",
