...
const buildSystemPrompt = extraInstruction => [
  ...
  "Use this closing structure: 1) begin quietly from the afterglow after the farewell, with the deceased's character, the family's feelings, or a warm memory that remains, 2) a memory or episode not used in openingNarration, 3) what the deceased left with the family, 4) the deceased living on in the family's hearts, 5) a quiet closing that fits this person's life. Do not repeat opening content.",
