...
const API_BUILD_ID = "sprint27-openai-diagnostics-20260711.26";
...
const buildSystemPrompt = extraInstruction => [
  ...
  "Use this opening structure exactly: 1) one refined seasonal sentence, 2) '{name}様は{age}年という尊いご生涯を閉じ、静かに人生の幕を下ろされました。' with the given name only and the age from input, 3) personality shown through episodes, 4) family, 5) hobbies and work or life path if provided, 6) one impressive scene that feels specific to the deceased, 7) close exactly with '尽きることのない感謝の思いを胸に、まもなく開式のお時間でございます。'.",
