...
const buildStableFamilyPortrait = (draft, prompt) => {
  ...
  const openingNarration = [
    seasonSentence,
    lifeSentence,
    `いつも笑っている顔しか思い出せないというご家族の言葉どおり、${givenName}様をたどる思い出には、いつも明るい表情が重なります。歌に声を合わせ、ときには踊るように身体を動かされる、その愛らしいご様子も、今なお胸に浮かびます。`,
  ...
  const closingNarration = [
    `お誕生日月の${month}月には、親子三代で${locations}へ出かけられました。訪れた土地の数だけ、ご家族で分かち合った時間。これからその地名に触れるたび、旅の日の${givenName}様が懐かしく思い出されることでしょう。`,
